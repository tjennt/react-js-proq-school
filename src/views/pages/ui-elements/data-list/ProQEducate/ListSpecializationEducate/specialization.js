...
import ListSpecializationEducation from "./ListSpecializationEducation";
    ...
    return (
      <React.Fragment>
        <Breadcrumbs
          ...
          breadCrumbActive="Danh sách chuyên ngành"
        />
        <Row>
          <Col sm="12">
...
export default connect(null, { logoutWithJWT })(specialization);
