...
import Sidebar from "./DataListBlogSidebar";
...
class ThumbViewBlogConfig extends Component {
  ...
  handleDelete = (row) => {
    const { deleteData, getDataBlog } = this.props;
    deleteData(row);
    getDataBlog(this.props.parsedFilter);
  ...
  render() {
    ...
    let { dataTagsBLog, dataList, thumbView } = this.props;
