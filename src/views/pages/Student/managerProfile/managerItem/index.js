...
export default function ManagerItem(props) {
  ...
  const date = data ? (new Date(data.studentId.dob)).toLocaleDateString('zh-HK') : "";
  return (
    <React.Fragment>
      <Modal
        title="Đổi mật khẩu"
          ...
          <TabContent activeTab="1">
            <TabPane tabId="1">
              <ListGroup flush className="text-left">
                ...
                <ListGroupItem>
                  Họ và tên : {data ? data.studentId.fullName : ""}
                </ListGroupItem>
                <ListGroupItem>
                  Email : {data ? data.studentId.email : ""}
                </ListGroupItem>
                <ListGroupItem>
                  {" "}
                  Ngày sinh: {date}{" "}
                ...
                <ListGroupItem>
                  Địa chỉ : {data ? data.studentId.address : ""}{" "}
                </ListGroupItem>
              </ListGroup>
            </TabPane>
          </TabContent>
